...
./my_program/data_processing/bulk_processing_pipeline ./Vocabulary/ORBvoc.txt ./Examples/RGB-D/RealSense_D435i.yaml
...
#include <System.h>
#include <dirent.h>   // Directory iteration
#include <sys/stat.h> // Check if file/folder exists
...
int main(int argc, char **argv)
{
    ...
    string dataset_root = "./my_program/data_processing/data/processed_dataset";
