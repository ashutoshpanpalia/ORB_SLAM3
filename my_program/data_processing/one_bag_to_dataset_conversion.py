...
def extract_bag_to_dataset(bag_path, output_dir):
    ...
    try:
        ...
        print(f"[INFO] Loading bag file: {bag_path}")
...
def main():
    if len(sys.argv) != 3:
        print("\nUsage: python bag_to_dataset.py path_to_bag_file output_directory")
        print("\nExample:")
        print("  python bag_to_dataset.py recording.bag dataset_output\n")
        return 1
