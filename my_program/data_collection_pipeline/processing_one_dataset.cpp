...
./my_program/data_collection_pipeline/processing_one_dataset ./Vocabulary/ORBvoc.txt     ./Examples/RGB-D/RealSense_D435i.yaml ./my_program/data_collection_pipeline/data/processed_dataset/2026-01-27_14-54-39/
...
int main(int argc, char **argv)
{
    if(argc != 4)
    {
        ...
        cerr << endl;
        cerr << "Example: ./my_program/data_collection_pipeline/processing_one_dataset ./Vocabulary/ORBvoc.txt     ./Examples/RGB-D/RealSense_D435i.yaml ./my_program/data_collection_pipeline/data/processed_dataset/2026-01-27_14-54-39/" << endl;
        cerr << endl;
    ...
    // Save trajectories inside dataset directory
    string output_dir = strPathToSequence;
    if (output_dir.back() != '/' && output_dir.back() != '\\') {
        output_dir += "/";
    }

    string traj_camera = output_dir + dataset_name + "_CameraTrajectory.txt";
    string traj_keyframe = output_dir + dataset_name + "_KeyFrameTrajectory.txt";
